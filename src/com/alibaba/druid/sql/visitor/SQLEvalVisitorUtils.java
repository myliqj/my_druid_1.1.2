...
public class SQLEvalVisitorUtils {
    ...
    public static boolean isSimpleCountTableSource(Object visitor, SQLTableSource tableSource) {
        ...
        return isSimpleCountTableSource(null, subQuery.getSelect());
    }

    public static boolean isSimpleCountTableSource(Object visitor, SQLSelect select) {
        ...
        if (query instanceof SQLSelectQueryBlock) {
            ...
            if (queryBlock.getWhere() == null) {
                ...
                Object whereValue = true;//getValue(null, queryBlock.getWhere());
    ...
    public static boolean visit(SQLEvalVisitor visitor, SQLQueryExpr x) {
        if (isSimpleCountTableSource(null, ((SQLQueryExpr) x).getSubQuery())) {
